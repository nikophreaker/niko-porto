...
<template>
  <!-- <div class="bg-primary text-white px-6 py-4 md:px-12 lg:py-8 flex justify-between items-center border-b rounded mb-3 shadow sm:flex sm:items-start sm:justify-end xl:mb-7">
    Component: Header
  </div> -->

  <header
    class="bg-transparent py-5 backdrop-blur border-b border-gray-200 dark:border-gray-800 -mb-px fixed top-0 left-0 right-0 z-50 lg:mb-0 lg:border-0">
    <div class="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl flex items-center justify-between gap-3 h-[--header-height]">
        ...
        <div class="relative inline-flex text-left rtl:text-right">
          <div class="inline-flex w-full" role="button">
            <!-- <a aria-current="page" href="/"
              class="router-link-active router-link-exact-active flex gap-2 items-end"><svg
                class="text-black dark:text-white block w-auto h-6" width="800" height="200" viewBox="0 0 800 200"
              ...
              <div class="relative inline-flex"><span
      ...
      <ul class="text-white items-center gap-x-8 hidden lg:flex">
        <li class="relative">
          <div class="relative">
            <div class="inline-flex w-full" role="button">
              <a class="text-sm/6 font-semibold flex items-center gap-1 hover:text-green-500" href="/docs">Home<span
                  class="i-ph-caret-down transform transition-transform duration-200 flex-shrink-0 w-4 h-4"></span></a>
            </div>
          </div>
        </li>
        <li class="relative">
          <div class="relative">
            <div class="inline-flex w-full" role="button">
              <a class="text-sm/6 font-semibold flex items-center gap-1 hover:text-green-500" href="/modules">About<span
                  class="i-ph-caret-down transform transition-transform duration-200 flex-shrink-0 w-4 h-4"></span></a>
            </div>
          </div>
        </li>
          ...
          <div class="relative">
            <div class="inline-flex w-full" role="button">
              <a class="text-sm/6 font-semibold flex items-center gap-1 hover:text-green-500"
                href="/templates">Skill<span
                  class="i-ph-caret-down transform transition-transform duration-200 flex-shrink-0 w-4 h-4"></span></a>
            </div>
          </div>
        </li>
        <li class="relative">
          <a class="text-sm/6 font-semibold flex items-center gap-1 hover:text-green-500" href="/showcase">Education
          </a>
        </li>
        <li class="relative">
          <div class="relative">
        ...
        <li class="relative">
          <div class="relative">
            <div class="inline-flex w-full" role="button">
              <a class="text-sm/6 font-semibold flex items-center gap-1 hover:text-green-500"
                href="/enterprise">Experience<span
                  class="i-ph-caret-down transform transition-transform duration-200 flex-shrink-0 w-4 h-4"></span></a>
            </div>
          </div>
        </li>
        <li class="relative">
          <a class="text-sm/6 font-semibold flex items-center gap-1 hover:text-green-500" href="/blog">Contact
          </a>
        </li>
      </ul>
      <div class="flex items-center justify-end lg:flex-1 gap-1.5">
        <div class="relative inline-flex"><button type="button"
            ...
            aria-label="Search"><span class="i-ph-magnifying-glass-duotone flex-shrink-0 h-5 w-5"
        ...
        <div class="relative inline-flex"><a
            ...
            href="https://github.com/nuxt/nuxt" rel="noopener noreferrer" target="_blank"><span
              class="i-simple-icons-github flex-shrink-0 h-5 w-5" aria-hidden="true"></span><span
              class="">52.5K</span></a></div>
        <button type="button"
