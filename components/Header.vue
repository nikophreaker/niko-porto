      ...
      <div class="lg:flex-1 flex items-center gap-1.5">
        <div class="relative inline-flex text-left rtl:text-right">
          <div class="inline-flex w-full" role="button">
            <a aria-current="page" href="/" class="router-link-active router-link-exact-active flex gap-2 items-end">
              <!-- <img class="h-6" src="~/assets/image/ic_nikx.jpg" /> -->
              ...
              <!-- <div class="relative inline-flex"><span
                  class="text-white inline-flex items-center text-xs px-1.5 py-0.5 bg-primary-50 dark:bg-primary-400 dark:bg-opacity-10 text-primary-500 dark:text-primary-400  dark:ring-primary-400 ring-opacity-25  -mb-[2px] rounded font-semibold">
                  Niko</span></div> -->
            </a>
          </div>
        </div>
